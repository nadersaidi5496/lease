...
@Component({
  selector: 'app-savoir-faire-evaluation',
  templateUrl: './savoir-faire-evaluation.component.html',
  styleUrls: ['./savoir-faire-evaluation.component.css']
})
export class SavoirFaireEvaluationComponent implements OnInit {
  ...
  ChargerData() {
    this.service.getNoteSavoirByCinAndType(this.cin, 'SavoirFaire')
    .subscribe(async res => {
      this.Data = await res;
      console.log(res);
    });
