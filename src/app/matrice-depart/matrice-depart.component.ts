...
@Component({
  selector: 'app-matrice-depart',
  templateUrl: './matrice-depart.component.html',
  styleUrls: ['./matrice-depart.component.css']
})
export class MatriceDepartComponent implements OnInit {
  ...
  chargeData(){
    ...
    this.employeeService.getEmployeesByImapctAndPoba('Fort','Faible')
    .subscribe(res=>{
      this.Data=res;
      ...
      this.employeeService.getEmployeesByImapctAndPoba('Fort','Moyenne')
      .subscribe(res=>{
        this.Data=res;
        console.log(this.Data);
        ...
        this.employeeService.getEmployeesByImapctAndPoba('Fort','Fort')
        .subscribe(res=>{
          this.Data=res;
          console.log(this.Data);
          ...
          this.employeeService.getEmployeesByImapctAndPoba('Moyenne','Faible')
          .subscribe(res=>{
            this.Data=res;
            console.log(this.Data);
            ...
            this.employeeService.getEmployeesByImapctAndPoba('Moyenne','Moyenne')
          .subscribe(res=>{
            this.Data=res;
            console.log(this.Data);
            ...
            this.employeeService.getEmployeesByImapctAndPoba('Moyenne','Fort')
            .subscribe(res=>{
              this.Data=res;
              console.log(this.Data);
              ...
              this.employeeService.getEmployeesByImapctAndPoba('Faible','Faible')
              .subscribe(res=>{
                this.Data=res;
                console.log(this.Data);
                ...
                this.employeeService.getEmployeesByImapctAndPoba('Faible','Moyenne')
                .subscribe(res=>{
                  this.Data=res;
                  console.log(this.Data);
                  ...
                  this.employeeService.getEmployeesByImapctAndPoba('Faible','Fort')
                  .subscribe(res=>{
                    this.Data=res;
                    console.log(this.Data);
